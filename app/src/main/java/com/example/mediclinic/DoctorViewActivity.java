...
public class DoctorViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        refresh.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(v.getContext(), com.example.mediclinic.DoctorViewActivity.class);
                finish();
    ...
    public void EditClinic(View view){
        Intent i = new Intent(com.example.mediclinic.DoctorViewActivity.this, com.example.mediclinic.Doc_dashboard.class);
        startActivity(i);
    }
    ...
    ValueEventListener valueEventListener = new ValueEventListener() {
        ...
        public void onDataChange(@NonNull DataSnapshot snapshot) {
            ...
            patientAdapter= new PatientAdapter(com.example.mediclinic.DoctorViewActivity.this,patient1);
    ...
    public void vieHome(View view){
        Intent in = new Intent(DoctorViewActivity.this, Doc_dashboard.class);
        startActivity(in);
    }
