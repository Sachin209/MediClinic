...
public class P_ClinicAdapter extends RecyclerView.Adapter<com.example.mediclinic.P_ClinicAdapter.MyViewHolder> {
    private Context context;
    private ArrayList<com.example.mediclinic.Clinic> clinic1;
    public P_ClinicAdapter(Context context,ArrayList<com.example.mediclinic.Clinic> clinic1){
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int position) {
        com.example.mediclinic.Clinic clinic1 = this.clinic1.get(position);
