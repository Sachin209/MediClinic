...
public class PatientNoteAdapter extends RecyclerView.Adapter<PatientNoteAdapter.MyViewHolder> {

    private Context context;
    private ArrayList<PatientNote> notes;
    PatientNoteAdapter myAdapter;
    SwipeRefreshLayout swiperefreshlayout;

    public PatientNoteAdapter(Context context, ArrayList<PatientNote> notes){
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.pitem, viewGroup, false);
        return new MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int position) {
        PatientNote notes = this.notes.get(position);
            ...
            public void onClick(View v) {
                ...
                alertDlg.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("PatientNote").child(notes.getId());
        ...
        myViewHolder.btnEdit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(context, EditPatientNote.class);
